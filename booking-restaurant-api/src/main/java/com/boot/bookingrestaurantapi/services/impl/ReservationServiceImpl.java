...
public class ReservationServiceImpl implements ReservationService {
	...
	public ReservationRest getReservationById(Long reservationId) throws BookingExceptios {
		return modelMapper.map(getReservationEntity(reservationId), ReservationRest.class);
	}

	private Reservation getReservationEntity(Long reservationId) throws BookingExceptios {
